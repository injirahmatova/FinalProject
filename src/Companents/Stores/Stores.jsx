    ...
    <div className={styles.storeSection}>
      <div className={styles.container}>
        ...
        <select name="inputSelect" id="inputSelect">
          ...
          <option value="">Uşaq məhsulları</option>
          <option value="">Kosmetika</option>
          <option value="">Musiqi aksesuarları </option>
          <option value="">Multibrend mağazalar</option>
          <option value="">Geyim, ayaqqabı, aksesuarlar</option>
          <option value="">İdman məhsulları</option>
          <option value="">Məişət texnikası və elektronika</option>
          <option value="">Ev və təmir üçün məhsullar</option>
          <option value="">Maraq və hobbi</option>
          <option value="">Kitab</option>
          <option value="">Ev əşyaları</option>
        </select>
